    ...
    "    NdotL1                   =  max(dot(normal_PASS, normalize(light_POSITION_01.xyz)), 0.0);  \n" 
        //----------------------------------------------------------------------------                                                   
    ...
    "    gl_FragColor             = (    texture2D(Texture1,  varTexcoord.xy) * NdotL1* NdotL1-0.0                                                \n" 
    
    "                             + (texture2D(Texture1,  varTexcoord.xy) * 0.5 * highp vec4(max(pow(NdotL1, 10.0), 0.0)))*NdotL1*NdotL1    )                                                 \n" 
   
//   "                              + ( 0.2 * highp vec4(max(pow(NdotL1, 100.0), 0.0)))                                                \n" 
     
     "                            -  texture2D(Texture1,  varTexcoord.xy) *invert_NdotL1*.25;                                                                                               \n" 
